...
@Component({
  selector: 'app-cuestionario-respuesta-abierta-double',
  templateUrl: './cuestionario-respuesta-abierta-double.component.html',
  styleUrls: ['./cuestionario-respuesta-abierta-double.component.css']
})
export class CuestionarioRespuestaAbiertaDoubleComponent implements OnInit {
