...
@Component({
  selector: 'app-cuestionario-respuesta-abierta-pesos',
  templateUrl: './cuestionario-respuesta-abierta-pesos.component.html',
  styleUrls: ['./cuestionario-respuesta-abierta-pesos.component.css']
})
export class CuestionarioRespuestaAbiertaPesosComponent implements OnInit {
