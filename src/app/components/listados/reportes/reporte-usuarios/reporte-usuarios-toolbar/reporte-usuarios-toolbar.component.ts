...
@Component({
  selector: 'app-reporte-usuarios-toolbar',
  templateUrl: './reporte-usuarios-toolbar.component.html',
  styleUrls: ['./reporte-usuarios-toolbar.component.css']
})
export class ReporteUsuariosToolbarComponent implements OnInit {
