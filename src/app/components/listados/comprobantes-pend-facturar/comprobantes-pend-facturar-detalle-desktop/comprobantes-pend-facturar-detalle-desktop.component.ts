...
@Component({
  selector: 'app-comprobantes-pend-facturar-detalle-desktop',
  templateUrl: './comprobantes-pend-facturar-detalle-desktop.component.html',
  styleUrls: ['./comprobantes-pend-facturar-detalle-desktop.component.css']
})
export class ComprobantesPendFacturarDetalleDesktopComponent implements OnInit {
